Import-Module -Name "$PSScriptRoot\..\..\cRemoteDesktopSessionHostCommon.psm1"
if (!(Test-cRemoteDesktopSessionHostOsRequirement)) { Throw "The minimum OS requirement was not met."}
...
function Set-TargetResource
{
    ...
    else
    {
        ...
        $PSBoundParameters.Remove('SessionHost')
        if (Get-RDSessionHost @PSBoundParameters | Where-Object SessionHost -ne $SessionHost)
        {
            $PSBoundParameters.Add('SessionHost',$SessionHost)
